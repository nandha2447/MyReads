...
const BookShelf = (props) => (
    ...
    //         {props.isSearch? undefined : <h2 className="bookshelf-title">{props.title}</h2>}
    ...
    //           <ol className="books-grid">
                ...
                {props.books.map((book)=>(    
                  <div key={book.id} className="bookshelf"><div className="bookshelf-books"><ol className="books-grid"><li>
                  <div  className="book">
                    <div className="book-top">
