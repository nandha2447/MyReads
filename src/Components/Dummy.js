...
//            {/* <div className="book-title">{props.isSearch ? props.bookTitle : 'To Kill a Mockingbird'}</div>
//                     <div className="book-authors">{props.isSearch ? (props.authors!==undefined && `${props.authors[0]}`) : 'Harper Lee'}</div> */}
